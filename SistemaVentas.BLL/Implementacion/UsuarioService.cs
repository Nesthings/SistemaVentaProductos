    ...
    public class UsuarioService : IUsuarioService
    {
        ...
        public async Task<Usuario> Crear(Usuario entidad, Stream? Foto = null, string NombreFoto = "", string UrlPlantillaCorreo = "")
        {
            ...
            try
            {
                ...
                if (usuario_creado.IdUsuario == 0) throw new TaskCanceledException("No se pudo crear usuario");
        ...
        public async Task<bool> CambiarClave(int IdUsuario, string claveActual, string claveNueva)
        {
            try
            {
                ...
                if (usuario_encontrado.Clave != _utilidadesService.ConvertirSha256(claveActual)) throw new TaskCanceledException("La contraseña ingresada como actual, no es correcta");
        ...
        public async Task<bool> RestablecerClave(string Correo, string UrlPlantillaCorreo)
        {
            try
            {
                ...
                if (!correo_enviado)
                    throw new TaskCanceledException("Tenemos problemas, inténtalo de nuez al ratón");
