...

{
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
            ...
            CreateMap<Usuario, VMRol>()
           .ForMember(dest => dest.IdRol, opt => opt.MapFrom(src => src.IdRol))
           .ForMember(dest => dest.Descripcion, opt => opt.MapFrom(src => src.NombreRol));
            ...
            CreateMap<Negocio, VMNegocio>()
                ...
                opt => opt.MapFrom(origen => Convert.ToString(origen.PorcentajeImpuesto.Value, new CultureInfo("es-MXN")))
                );

            CreateMap<Negocio, VMNegocio>()
                .ForMember(destino =>
                destino.PorcentajeImpuesto,
                opt => opt.MapFrom(origen => Convert.ToDecimal(origen.PorcentajeImpuesto.Value, new CultureInfo("es-MXN")))
                );
